...
public final class ChatMessageProto {
  ...
  public static final class User extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return proto.ChatMessageProto.internal_static_proto_User_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return proto.ChatMessageProto.internal_static_proto_User_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              proto.ChatMessageProto.User.class, proto.ChatMessageProto.User.Builder.class);
    }
    ...
    public static proto.ChatMessageProto.User parseFrom(
    ...
    public static proto.ChatMessageProto.User parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static proto.ChatMessageProto.User parseFrom(
    ...
    public static proto.ChatMessageProto.User parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static proto.ChatMessageProto.User parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static proto.ChatMessageProto.User parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(proto.ChatMessageProto.User prototype) {
    ...
    public static final class Builder extends
        ...
        proto.ChatMessageProto.UserOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return proto.ChatMessageProto.internal_static_proto_User_descriptor;
      }
      ...
      // Construct using proto.ChatMessageProto.User.newBuilder()
      private Builder() {
      ...
      public proto.ChatMessageProto.User getDefaultInstanceForType() {
        return proto.ChatMessageProto.User.getDefaultInstance();
      }

      public proto.ChatMessageProto.User build() {
        proto.ChatMessageProto.User result = buildPartial();
      ...
      public proto.ChatMessageProto.User buildPartial() {
        proto.ChatMessageProto.User result = new proto.ChatMessageProto.User(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof proto.ChatMessageProto.User) {
          return mergeFrom((proto.ChatMessageProto.User)other);
        } else {
      ...
      public Builder mergeFrom(proto.ChatMessageProto.User other) {
        if (other == proto.ChatMessageProto.User.getDefaultInstance()) return this;
        if (other.hasName()) {
          bitField0_ |= 0x00000001;
          name_ = other.name_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        proto.ChatMessageProto.User parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (proto.ChatMessageProto.User) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  public interface ChatMessageOrBuilder extends
     ...
     * <code>required .proto.User user = 1;</code>
     */
    proto.ChatMessageProto.User getUser();
    /**
     * <code>required .proto.User user = 1;</code>
     */
    proto.ChatMessageProto.UserOrBuilder getUserOrBuilder();
  ...
  public static final class ChatMessage extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              proto.ChatMessageProto.User.Builder subBuilder = null;
              if (((bitField0_ & 0x00000001) == 0x00000001)) {
                subBuilder = user_.toBuilder();
              }
              user_ = input.readMessage(proto.ChatMessageProto.User.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    private proto.ChatMessageProto.User user_;
    /**
     * <code>required .proto.User user = 1;</code>
     */
     ...
     * <code>required .proto.User user = 1;</code>
     */
    public proto.ChatMessageProto.User getUser() {
      return user_;
    }
    /**
     * <code>required .proto.User user = 1;</code>
     */
    public proto.ChatMessageProto.UserOrBuilder getUserOrBuilder() {
      return user_;
    }
    ...
    public static final class Builder extends
      ...
      private proto.ChatMessageProto.User user_ = proto.ChatMessageProto.User.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          proto.ChatMessageProto.User, proto.ChatMessageProto.User.Builder, proto.ChatMessageProto.UserOrBuilder> userBuilder_;
      /**
       * <code>required .proto.User user = 1;</code>
       */
      public boolean hasUser() {
       ...
       * <code>required .proto.User user = 1;</code>
       */
      public Builder setUser(proto.ChatMessageProto.User value) {
        if (userBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setUser(
          proto.ChatMessageProto.User.Builder builderForValue) {
        if (userBuilder_ == null) {
       ...
       * <code>required .proto.User user = 1;</code>
       */
      public Builder mergeUser(proto.ChatMessageProto.User value) {
        if (userBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001) &&
              user_ != proto.ChatMessageProto.User.getDefaultInstance()) {
            user_ =
              proto.ChatMessageProto.User.newBuilder(user_).mergeFrom(value).buildPartial();
          } else {
            user_ = value;
          }
          onChanged();
       ...
       * <code>required .proto.User user = 1;</code>
       */
      public proto.ChatMessageProto.User.Builder getUserBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          proto.ChatMessageProto.User, proto.ChatMessageProto.User.Builder, proto.ChatMessageProto.UserOrBuilder> 
          getUserFieldBuilder() {
        if (userBuilder_ == null) {
